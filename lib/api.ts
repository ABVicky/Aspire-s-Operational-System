...
export const MOCK_TASKS: Task[] = [
  { id: 't1', projectId: 'p1', projectName: 'TechCorp Rebrand', title: 'Design new logo concepts', description: 'Create 5 initial logo concepts for client review. Focus on modern, minimal aesthetic.', assigneeId: 'emp002', assigneeName: 'Prachi Tiwari', creatorId: 'emp001', creatorName: 'Aashutosh Jaiswal', status: 'done', priority: 'high', dueDate: '2024-03-05', createdAt: '2024-02-01T10:00:00Z', updatedAt: '2024-03-05T14:00:00Z' },
  { id: 't2', projectId: 'p1', projectName: 'TechCorp Rebrand', title: 'Brand guidelines document', description: 'Create comprehensive brand guidelines covering typography, colors, imagery, and usage.', assigneeId: 'emp002', assigneeName: 'Prachi Tiwari', creatorId: 'emp001', creatorName: 'Aashutosh Jaiswal', status: 'in-progress', priority: 'high', dueDate: '2024-03-25', createdAt: '2024-02-10T10:00:00Z', updatedAt: '2024-03-12T09:00:00Z' },
  { id: 't3', projectId: 'p1', projectName: 'TechCorp Rebrand', title: 'Website redesign wireframes', description: 'Create low and high-fidelity wireframes for all key pages.', assigneeId: 'emp003', assigneeName: 'Soumyanetra Mitra', creatorId: 'emp002', creatorName: 'Prachi Tiwari', status: 'review', priority: 'medium', dueDate: '2024-03-20', createdAt: '2024-02-15T10:00:00Z', updatedAt: '2024-03-18T16:00:00Z' },
  { id: 't4', projectId: 'p2', projectName: 'RetailHub E-commerce', title: 'Set up Next.js project', description: 'Initialize the project with all required dependencies and folder structure.', assigneeId: 'emp003', assigneeName: 'Soumyanetra Mitra', creatorId: 'emp001', creatorName: 'Aashutosh Jaiswal', status: 'done', priority: 'urgent', dueDate: '2024-02-20', createdAt: '2024-02-15T10:00:00Z', updatedAt: '2024-02-19T17:00:00Z' },
  { id: 't5', projectId: 'p2', projectName: 'RetailHub E-commerce', title: 'Product listing page UI', description: 'Build the product grid with filters, sorting and pagination.', assigneeId: 'emp004', assigneeName: 'Shivam Saha', creatorId: 'emp003', creatorName: 'Soumyanetra Mitra', status: 'in-progress', priority: 'high', dueDate: '2024-03-30', createdAt: '2024-02-20T10:00:00Z', updatedAt: '2024-03-10T10:00:00Z' },
  { id: 't6', projectId: 'p2', projectName: 'RetailHub E-commerce', title: 'Shopping cart & checkout', description: 'Implement cart state management and multi-step checkout flow.', assigneeId: 'emp003', assigneeName: 'Soumyanetra Mitra', creatorId: 'emp001', creatorName: 'Aashutosh Jaiswal', status: 'todo', priority: 'high', dueDate: '2024-04-15', createdAt: '2024-02-25T10:00:00Z', updatedAt: '2024-02-25T10:00:00Z' },
  { id: 't7', projectId: 'p3', projectName: 'FinanceFirst Dashboard', title: 'Requirements gathering', description: 'Meet with client to document all dashboard requirements and KPIs.', assigneeId: 'emp001', assigneeName: 'Aashutosh Jaiswal', creatorId: 'emp031', creatorName: 'Atisha Tibrewal', status: 'in-progress', priority: 'medium', dueDate: '2024-03-25', createdAt: '2024-03-01T10:00:00Z', updatedAt: '2024-03-12T10:00:00Z' },
  { id: 't8', projectId: 'p2', projectName: 'RetailHub E-commerce', title: 'Payment gateway integration', description: 'Integrate Razorpay for payment processing.', assigneeId: 'emp004', assigneeName: 'Shivam Saha', creatorId: 'emp001', creatorName: 'Aashutosh Jaiswal', status: 'todo', priority: 'urgent', dueDate: '2024-04-20', createdAt: '2024-03-01T10:00:00Z', updatedAt: '2024-03-01T10:00:00Z' },
];
...
export let MOCK_CALENDAR_EVENTS: CalendarEvent[] = [
  { id: 'ev1', title: 'TechCorp Instagram Carousel', type: 'post', platform: 'Instagram', date: '2024-03-25', time: '10:00', assigneeId: 'emp003', assigneeName: 'Soumyanetra Mitra', creatorId: 'emp001', creatorName: 'Aashutosh Jaiswal', projectId: 'p1', projectName: 'TechCorp Rebrand', createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { id: 'ev2', title: 'Product Shoot — HealthPlus', type: 'shoot', date: '2024-03-27', time: '09:00', assigneeId: 'emp002', assigneeName: 'Prachi Tiwari', creatorId: 'emp031', creatorName: 'Atisha Tibrewal', clientId: 'c4', clientName: 'HealthPlus', createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { id: 'ev3', title: 'RetailHub Facebook Ad', type: 'post', platform: 'Facebook', date: '2024-03-28', time: '14:00', assigneeId: 'emp004', assigneeName: 'Shivam Saha', creatorId: 'emp001', creatorName: 'Aashutosh Jaiswal', projectId: 'p2', projectName: 'RetailHub E-commerce', createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { id: 'ev4', title: 'Q1 Strategy Meeting', type: 'meeting', date: '2024-03-26', time: '11:00', assigneeId: 'emp001', assigneeName: 'Aashutosh Jaiswal', creatorId: 'emp001', creatorName: 'Aashutosh Jaiswal', createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
];
